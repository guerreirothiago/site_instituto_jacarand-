            ...
            <footer class="footer">
                <div class="footer-content">
                    ...
                    <div style="margin-top: 16px; display: flex; flex-direction: column; gap: 8px;">
                        <p><img src="image/localização.jpg" alt="Localização" style="width: 20px; height: 20px; margin-right: 8px; vertical-align: middle;"><strong>Endereço Manaus:</strong> R. Comendador Clementino, 183C - Centro, Manaus - AM, 69025-000</p>
